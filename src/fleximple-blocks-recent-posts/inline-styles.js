...
const InlineStyles = ({
	defaultClassName,
	attributes: { blockId, layout, columns, gapRow, gapColumn, aspectRatio },
}) => {
      ...
      ${blockSelector} .${defaultClassName}__entry-picture { padding-bottom: ${
        ...
        ${blockSelector} {
          ...
          ${
						...
						gapColumn.medium.value !== gapColumn.small.value
        ...
        ${blockSelector} {
          ...
          ${
						...
						gapColumn.large.value !== gapColumn.medium.value
